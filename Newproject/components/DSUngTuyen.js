...
class DSUngTuyen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    componentDidMount = async () => {
        ...
        await fetch(host + '/DanhSach/DSUngTuyen.php', {
            method: 'POST',
            headers: {
        ...
        return (
            ...
            <View style={styles.Container}>
                <View style={styles.cardHeaderContainer}>
                    <Text style={styles.cardHeader}>Danh Sách Ứng Tuyển Của Bạn</Text>
                </View>
                <FlatList
                    data={dataSource}
